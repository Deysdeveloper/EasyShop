...
fun CheckoutPage(modifier: Modifier) {
        ...
        .fillMaxSize())
    {
        ...
        RowCheckoutItems(modifier = Modifier,title = "Discount(-)", value = discount.value.toString())
        Spacer(modifier= Modifier.height(8.dp))
        RowCheckoutItems(modifier = Modifier,title = "Tax(+)", value = Tax.value.toString())
        HorizontalDivider()
        Spacer(modifier= Modifier.height(16.dp))
        Text(text="To Pay",
            modifier = Modifier.fillMaxWidth(),
            textAlign =TextAlign.Center)
        Text(text="$"+Total.value.toString(),
            modifier= Modifier.fillMaxWidth(),
            fontSize = 30.sp,
...
@Composable
fun RowCheckoutItems(modifier: Modifier,title:String,value:String)
{
